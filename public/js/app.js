...
var storeApp = angular.module('AngularStore', []).
  ...
  $routeProvider.
      when('/store', {
        templateUrl: '/assets/partials/store.htm',
        controller: storeController 
      }).
      when('/products/:productSku', {
        templateUrl: '/assets/partials/product.htm',
        controller: storeController
      }).
      when('/cart', {
        templateUrl: '/assets/partials/shoppingCart.htm',
        controller: storeController
      }).
      otherwise({
        redirectTo: '/store'
...
storeApp.factory("DataService", function () {
    ...
    myCart.addCheckoutParameters("Stripe", "pk_test_00TwKp0f4eKdXGqllENdpE3a",
        {
